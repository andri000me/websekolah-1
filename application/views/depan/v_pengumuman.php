...
<head>
    ...
    <title>Pengumuman | <?php echo $set->nama_sekolah; ?></title>
                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('pengumuman');?>" style="color:white;background: black; border-radius: 15%;">Pengumuman</a>
                                </li>
                                <li class="nav-item">
