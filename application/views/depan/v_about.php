...
<head>
    ...
    <title>About | <?php echo $set->nama_sekolah; ?></title>
                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('about');?>" style="color:white;background: black; border-radius: 15%;">About</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Hal ini seiring dengan penguasaan teknologi untuk dimanfaatkan sebaik mungkin,
                  ...
                  kami mengejewantahkan nilai-nilai pendidikan yang tertuang dalam visi misi <?php echo $set->nama_sekolah; ?>,
                ...
                <ul><li>Terwujudnya SMK yang mampu menciptakan tamatan yang cerdas, produktif, kompetitif, bertaqwa, serta berakhlaq mulia</li></ul>

                <h4>Misi : </h4>
                <ol>
                    <li>Melaksanakan pembelajaran yang bertaraf international berbasis keunggulan seni dan budaya</li>
                    <li>Menjalin kerjasama dengan Dunia Usaha / Dunia Industri dan Stakeholder</li>
                    <li>Mewujudkan wawasan wiyata mandala dan meningkatkan citra Sekolah Menengah Kejuruan</li>
                    <li>Menghasilkan tamatan yang cerdas, produktif, bertaqwa dan berakhlak mulia</li>
                </ol>
                </div>
                <div class="col-md-5">
                    <img src="<?php echo base_url().'theme/images/'.$set->photo_kepala.''?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
