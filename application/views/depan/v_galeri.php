...
<head>
    ...
    <title>Gallery Photo | <?php echo $set->nama_sekolah; ?></title>
                  ...
                  <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                      ...
                      <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('galeri');?>" style="color:white;background: black; border-radius: 15%;">Gallery</a>
                                </li>
                                <li class="nav-item">
